(function() {
  var RESERVED_NAMES, buildPage, buildPages, buildScripts, buildStyles, eco, formatDate, fs, getLayout, log, markdown, path, read, slugify, stitch, stylus, util, write, _, _verbosity;
