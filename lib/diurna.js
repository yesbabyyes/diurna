(function() {
  var RESERVED_NAMES, buildPage, buildPages, buildScripts, buildStyles, eco, formatDate, fs, getLayout, log, markdown, mkdirs, path, read, slugify, stitch, stylus, util, write, _, _verbosity;
  ...
  buildPages = function(from, to) {
    ...
    traverse = function(options, parent) {
      ...
      return fs.readdir(currentDir, function(err, files) {
        var basename, context, dirNames, dst, extension, file, filePath, layouts, node, page, pageLayout, pages, src, stat, _i, _j, _len, _len2, _ref2, _ref3, _results;
        if (err) {
