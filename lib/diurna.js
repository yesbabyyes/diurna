(function() {
  var RESERVED_NAMES, buildPage, buildPages, buildScripts, buildStyles, eco, fs, getTemplate, helpers, link, log, markdown, mkdirs, path, read, slugify, stitch, stylus, util, write, _, _verbosity;
