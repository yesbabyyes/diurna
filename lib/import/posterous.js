  ...
  exports["import"] = function(args, next) {
    ...
    if (argv.l) {
      ...
      return posterous.get("Site", argv.s, {}, function(err, site) {
        var body, config, display_name, firstname, lastname, nickname, profile_pic, _ref;
        if (err) {
          return console.error(err);
        }
        config = {
        ...
        _ref = site.admins[0], display_name = _ref.display_name, nickname = _ref.nickname, firstname = _ref.firstname, lastname = _ref.lastname, profile_pic = _ref.profile_pic, body = _ref.body;
        config.author = {
